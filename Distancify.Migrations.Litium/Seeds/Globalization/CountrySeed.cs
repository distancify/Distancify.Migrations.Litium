...
{
    public class CountrySeed : ISeed, ISeedGenerator<SeedBuilder.LitiumGraphQlModel.Globalization.Country>
    {
        ...
        internal static CountrySeed CreateFrom(SeedBuilder.LitiumGraphQlModel.Globalization.Country country)
        {
        ...
        public ISeedGenerator<SeedBuilder.LitiumGraphQlModel.Globalization.Country> Update(SeedBuilder.LitiumGraphQlModel.Globalization.Country data)
        {
        ...
        public void WriteMigration(StringBuilder builder)
        {
            ...
            {
                builder.AppendLine($"\t\t\t\t.{nameof(CountrySeed.WithStandardVatRate)}({country.StandardVatRate.ToString(CultureInfo.InvariantCulture)}m)");
            }
            //WithTaxClassLink
