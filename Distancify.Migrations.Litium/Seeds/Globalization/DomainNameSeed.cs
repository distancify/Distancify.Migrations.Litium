...
{
    public class DomainNameSeed : ISeed, ISeedGenerator<SeedBuilder.LitiumGraphqlModel.DomainName>
    {
        ...
        internal static DomainNameSeed CreateFrom(SeedBuilder.LitiumGraphqlModel.DomainName channel)
        {
        ...
        public ISeedGenerator<SeedBuilder.LitiumGraphqlModel.DomainName> Update(SeedBuilder.LitiumGraphqlModel.DomainName data)
        {
